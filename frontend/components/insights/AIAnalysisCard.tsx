...
export const AIAnalysisCard: React.FC<AIAnalysisCardProps> = ({
  ...
  return (
    <div className="bg-black/20 border border-slate-700/50 rounded-xl p-4 hover:border-slate-600/50 transition-colors group overflow-hidden" style={{ backgroundColor: 'rgb(var(--panel-rgb) / 0.7)' }}>
